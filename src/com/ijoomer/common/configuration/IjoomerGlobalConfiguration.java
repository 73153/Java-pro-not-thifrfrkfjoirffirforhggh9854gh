...
public class IjoomerGlobalConfiguration extends IjoomerResponseValidator implements IjoomerSharedPreferences {
	 ...
	 */
	public static void setJreviewArticleAttachmentUploadSize(int attachmentUploadSize) {
	...
	public static String getJreviewArticlePhotoUploadLimit() {
		return SmartApplication.REF_SMART_APPLICATION.readSharedPreferences().getString(IjoomerSharedPreferences.SP_JREVIEWARTICLEPHOTOUPLOADLIMIT, "");
	}
	 ...
	 * @return represented {@link Integer}
	 */
	public static int getJreviewArticleVideoUploadLimit() {
		return SmartApplication.REF_SMART_APPLICATION.readSharedPreferences().getInt(IjoomerSharedPreferences.SP_JREVIEWARTICLEVIDEOUPLOADLIMIT, 0);
	}
	 ...
	 */
	public static void setJreviewArticleVideoUploadLimit(int videoUploadLimit) {
	 ...
	 * @return represented {@link Integer}
	 */
	public static int getJreviewArticleAudioUploadLimit() {
		return SmartApplication.REF_SMART_APPLICATION.readSharedPreferences().getInt(IjoomerSharedPreferences.SP_JREVIEWARTICLEAUDIOUPLOADLIMIT, 0);
	}
	 ...
	 */
	public static void setJreviewArticleAudioUploadLimit(int audioUploadLimit) {
	 ...
	 * @return represented {@link Integer}
	 */
	public static int getJreviewArticleAttachmentUploadLimit() {
		return SmartApplication.REF_SMART_APPLICATION.readSharedPreferences().getInt(IjoomerSharedPreferences.SP_JREVIEWARTICLEATTACHMENTUPLOADLIMIT, 0);
	}
	 ...
	 */
	public static void setJreviewArticleAttachmentUploadLimit(int attachmentUploadLimit) {
	 ...
	 * @return allowsearchbyauthor represented is allow search by author
	 */
	public void setJreviewVideoEnable(String allowsearchbyauthor) {
		SmartApplication.REF_SMART_APPLICATION.writeSharedPreferences(IjoomerSharedPreferences.SP_JREVIEWVIDEOENABLE, allowsearchbyauthor);
	}
	 ...
	 * @return allowsearchbyauthor represented is allow search by author
	 */
	public void setJreviewAudioEnable(String allowsearchbyauthor) {
		SmartApplication.REF_SMART_APPLICATION.writeSharedPreferences(IjoomerSharedPreferences.SP_JREVIEWAUDIOENABLE, allowsearchbyauthor);
	}
	 ...
	 * @return allowsearchbyauthor represented is allow search by author
	 */
	public void setJreviewAttachmentEnable(String allowsearchbyauthor) {
		SmartApplication.REF_SMART_APPLICATION.writeSharedPreferences(IjoomerSharedPreferences.SP_JREVIEWATTACHMENTENABLE, allowsearchbyauthor);
	}
							...
							try {
								...
								try {
									if (jreviewConfig.has("media_attachment_max_size")) {
										setJreviewArticleAttachmentUploadSize(Integer.parseInt(jreviewConfig.getString("media_attachment_max_size")));
									} else {
								...
								try {
									if (jreviewConfig.has("media_video_max_uploads_listing")) {
										setJreviewArticleVideoUploadLimit(Integer.parseInt(jreviewConfig.getString("media_video_max_uploads_listing")));
									} else {
								...
								try {
									if (jreviewConfig.has("media_audio_max_uploads_listing")) {
										setJreviewArticleAudioUploadLimit(Integer.parseInt(jreviewConfig.getString("media_audio_max_uploads_listing")));
									} else {
								...
								try {
									if (jreviewConfig.has("media_attachment_max_uploads_listing")) {
										setJreviewArticleAttachmentUploadLimit(Integer.parseInt(jreviewConfig.getString("media_attachment_max_uploads_listing")));
									} else {
