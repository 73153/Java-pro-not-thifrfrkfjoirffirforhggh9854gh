...
public abstract class IjoomerApplicationConfiguration implements IjoomerSharedPreferences {
	...
	public static int CUSTOMER = 11;
	public static int SELLER = 10;
		...
		try {
			if (twitterConsumerKey == null) {
				...
				if (IjoomerGlobalConfiguration.getJomsocialVersion().equals(IjoomerGlobalConfiguration.JOMVERSION_V30)) {
					IjoomerScreenHolder.originalScreens.put("Registration", "com.df.src.IjoomerRegistrationStep1Activity_v30");
	...
	public static int getUserType() {
		if (SmartApplication.REF_SMART_APPLICATION.readSharedPreferences().getString(SP_LOGIN_TYPE, "Seller").equals("Seller")) {
			return SELLER;
		} else {
			return CUSTOMER;
		}
	...
	public static String getRestaurantId() {
		return SmartApplication.REF_SMART_APPLICATION.readSharedPreferences().getString(SP_REST_ID, "0");
	}
	...
	public static String getDomainName() {
		try {
			...
			return SmartApplication.REF_SMART_APPLICATION.readSharedPreferences().getString(SP_CLIENT_DOMAIN, mContext.getString(R.string.domain_name));
		} catch (Exception e) {
		}
		return null;
