...
public class DFSCurrentOrderListFragment extends SmartFragment {
	...
	public DFSCurrentOrderListFragment() {
	}
	...
	private void deleteOrders() {
		...
		dataprovider.deleteCurrentOrders(strOrderIds, new WebCallListener() {
	...
	public void getCurrentOrdersList() {
		((DFSOrderListActivity) getActivity()).showProgressDialog(getString(R.string.df_loading_current_orders), getActivity());
		dataprovider.getCurrentOrdersList(new WebCallListener() {
