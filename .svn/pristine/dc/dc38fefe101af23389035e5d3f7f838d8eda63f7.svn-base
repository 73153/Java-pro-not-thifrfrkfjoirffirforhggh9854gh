...
public class IjoomerShareActivity extends IjoomerSuperMaster {
	...
	private IjoomerRadioButton rdbTwitterShare;
	private IjoomerRadioButton rdbGooglePlusShare;
	private IjoomerRadioButton rdbEmailShare;
	 ...
	 */
	 ...
	 public void initComponents() {
		 ...
		 rdbEmailShare = (IjoomerRadioButton) findViewById(R.id.rdbEmailShare);
		 rdbGooglePlusShare = (IjoomerRadioButton) findViewById(R.id.rdbGooglePlusShare);
		 rdbTwitterShare = (IjoomerRadioButton) findViewById(R.id.rdbTwitterShare);
		 ...
		 btnSend.setOnClickListener(new OnClickListener() {
			 ...
			 public void onClick(View v) {
				 if (edtShareEmail.getText().toString().trim().length() > 0) {
					 ...
					 ting(getString(R.string.df_email) + " " + getString(R.string.validation_value_required));
				 }
			 }
		 });
