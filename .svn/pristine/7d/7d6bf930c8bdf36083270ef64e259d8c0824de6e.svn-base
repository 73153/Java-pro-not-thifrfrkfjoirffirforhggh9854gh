...
public class DFSSettingsShareActivity extends DFSellerMasterActivity {
    ...
    public int setLayoutId() {
        return R.layout.dfs_settings_share;
    }
    ...
    public void setActionListeners() {
        imgEmail.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                //String message = getSmartApplication().readSharedPreferences().getString(SP_DF_USERNAME,"") +"  just ordered a dish from us using " + getSmartApplication().readSharedPreferences().getString(SP_DF_SHARELINK,"");
        ...
        imgFacebook.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    loadNew(IjoomerFacebookSharingActivity.class, DFSSettingsShareActivity.this, false);
                } catch (Throwable e) {
                    e.printStackTrace();
                }
            }
