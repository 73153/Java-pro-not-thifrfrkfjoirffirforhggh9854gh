...
public class IjoomerRegistration extends IjoomerResponseValidator {
	 ...
	 */
	public void signUpNewUser(final String userName, final String passWord, final String email, final String mobile, final String userRegistrationType, final String catIds,
			final boolean isFb,final WebCallListener target) {
		...
		new AsyncTask<Void, Void, Object>() {
			...
			protected Object doInBackground(Void... params) {
				...
				try {
                    ...
                    taskData.put(FB, isFb?"1":"0");
                    taskData.put(DEVICETOKEN, getDeviceUDID(mContext));
                    taskData.put(DEVICETYPE, ANDROID);
