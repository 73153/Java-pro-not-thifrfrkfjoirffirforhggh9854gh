	...
	public static HashMap<String, String> originalScreens = new HashMap<String, String>() {
		{
			...
			put("Login", "com.df.src.IjoomerLoginActivity");
			put("Registration", "com.df.src.IjoomerRegistrationStep1Activity");
			put("Home", "com.df.src.IjoomerHomeActivity");
			...
			put("DisplayAsMenu", "com.df.src.IjoomerMenuActivity");
